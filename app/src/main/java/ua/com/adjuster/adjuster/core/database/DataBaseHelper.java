package ua.com.adjuster.adjuster.core.database;
...
public class DataBaseHelper extends SQLiteOpenHelper{
    ...
    private static final String USERNAME = "NAME";//имя
    private static final String PASSWORD = "PASSWORD";//пароль



    private static final String ADJUSTMENT_TASKS = "ADJUSTMENT_TASKS";//всего пристрелок
    private static final String SUCCESS_ADJUSTMENT_TASKS = "SUCCESS_ADJUSTMENT_TASKS";//успешных пристрелок
    private static final String UNSUCCESS_ADJUSTMENT_TASKS = "UNSUCCESS_ADJUSTMENT_TASKS";//неудачных пристрелок
    private static final String PERCENTAGE_OF_SUCCESS_ADJUSTMENT = "PERCENTAGE_OF_SUCCESS_ADJUSTMENT";//процент удачных пристрелок
    private static final String AVERAGE_TIME = "AVERAGE_TIME";//среднее время
    private static final String MIL_TASKS = "MIL_TASKS";//всего задач с тысячными
    private static final String SUCCESS_MIL_TASKS = "SUCCESS_MIL_TASKS";//успешных задач с тысячными
    private static final String UNSUCCESS_MIL_TASKS = "UNSUCCESS_MIL_TASKS";//неудачных задач с тысячными
    private static final String PERCENTAGE_OF_SUCCESS_MILTASKS = "PERCENTAGE_OF_SUCCESS_MILTASKS";//процент удачных задач
...
/*
    ...
    * указаного пароля для юзера в бд и переданого*/
    ...
    /*Возвращает сообщение с статистикой пользователя по имени*/
    ...
    /*Метод для получения строки с временем из милисекунд*/
