...
public class DualObservingAdjustmentTask extends AdjustmentTask {
 ...
 /*Дальность наблюдателя левого КСП*/
    ...
    public DualObservingAdjustmentTask(Parcel parcel) {
        ...
        /*Тут и везде, костыль с передачей цифры вместо Boolean связан с ошибкой в языке*/
    ...
    /*Метод, генерирующий наблюдение в виде строки в нескольких вариантах (массив) и корректуру в переменную*/
    ...
    /*Метод возвращает строковое описание боевого порядка*/
    ...
    /*Метод проверяет переданую корректуру. В различных случаях возвращает различные сообщения о результате проверки*/
    ...
    /*Метод возвращает строковое описание коефициентов используемых при рассчете пристрелки*/
